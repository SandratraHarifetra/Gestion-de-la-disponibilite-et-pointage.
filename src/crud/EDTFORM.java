...
/**
 * Servlet implementation class EDTFORM
 */
@WebServlet("/EDTFORM")
public class EDTFORM extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String Enseignant = request.getParameter("niveau");
		...
		// Samedi
			...
			String Samedi9 = request.getParameter("_4_5_PM_Samedi");
				...
				String requete = "INSERT INTO emploidutemps VALUES(NULL,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				request.setAttribute("msg", "l'emploi du temps est envoyé avec succès !!!");
